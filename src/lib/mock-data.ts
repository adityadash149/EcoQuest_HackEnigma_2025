...
export const lessons: Lesson[] = [
  ...
  },
  {
    ...
    image: 'https://www.youtube.com/embed/nizXCsCGk7k',
  ...
  },
  {
    ...
    scenarios: [
      ...
      {
        scenarioTitle: 'Healing the Land',
        scenarioDescription: 'In addition to planting, techniques are used to improve the health of the soil itself, which has been damaged by erosion and overuse.',
        question: 'Which method helps to regenerate degraded soil?',
        correctAnswer: 'Agroforestry (mixing trees with crops).',
        incorrectAnswers: [
          'Covering the soil with plastic sheets.',
          'Using more chemical fertilizers.',
          'Driving heavy trucks over the land.',
        ],
        explanation: 'Agroforestry combines agriculture and forestry. Trees enrich the soil with nutrients, prevent erosion, and help retain moisture, making the land more fertile and productive for crops.',
        animationUpdate: 'The soil around the trees darkens, and small green crops begin to grow between the trees.',
      },
      {
        scenarioTitle: 'A Corridor for Wildlife',
        scenarioDescription: 'The Aravalli range is a natural corridor for wildlife moving between different forests. The green wall project aims to restore this broken corridor.',
        question: 'How does the green wall help animals like leopards and jackals?',
        correctAnswer: 'It provides a safe passageway between habitats.',
        incorrectAnswers: [
          'It provides them with a new race track.',
          'It separates them from other animals.',
          'It makes them easier to see for tourists.',
        ],
        explanation: 'By reconnecting fragmented forests, the green wall allows wildlife to move safely in search of food and mates, which is essential for maintaining healthy and genetically diverse animal populations.',
        animationUpdate: 'Silhouettes of a leopard and a jackal are seen moving safely through the growing green corridor.',
      },
      {
        scenarioTitle: 'Economic Benefits',
        scenarioDescription: 'The restored ecosystem begins to provide new economic opportunities for the local communities.',
        question: 'Besides jobs in planting, what is another economic benefit of the green wall?',
        correctAnswer: 'Sustainable harvesting of products like gum, honey, and fodder.',
        incorrectAnswers: [
          'Selling tickets to see the wall.',
          'Mining for rocks under the trees.',
          'Exporting the sand that was stopped.',
        ],
        explanation: 'A healthy forest ecosystem provides numerous non-timber products. Communities can sustainably harvest these resources, creating diverse and resilient local economies.',
        animationUpdate: 'A small marketplace appears, with people selling honey, fodder for animals, and other goods derived from the forest.',
      },
      {
        scenarioTitle: 'Climate Resilience',
        scenarioDescription: 'The green wall helps buffer the region against the harsh impacts of climate change, such as extreme heat and irregular rainfall.',
        question: 'How do the trees help make the area more resilient to climate change?',
        correctAnswer: 'By cooling the local temperature and improving the water cycle.',
        incorrectAnswers: [
          'By attracting stronger winds.',
          'By making the area drier.',
          'They have no effect on the climate.',
        ],
        explanation: 'Trees provide shade, which cools the air and ground. Through transpiration, they release moisture into the atmosphere, which can influence local rainfall patterns and create a more stable, less extreme climate.',
        animationUpdate: 'The harsh sun in the sky becomes milder, and gentle rain clouds form over the green wall.',
      },
      {
        scenarioTitle: 'Stopping the Dust',
        scenarioDescription: 'As the green wall matures, it becomes a formidable barrier against the dust-laden winds blowing from the Thar Desert.',
        question: 'What is the most direct impact of the green wall on nearby cities like Delhi?',
        correctAnswer: 'A significant reduction in dust pollution and improved air quality.',
        incorrectAnswers: [
          'It makes the cities louder.',
          'It causes more traffic.',
          'It has no impact on distant cities.',
        ],
        explanation: 'The Aravalli hills and the green wall act as a natural barrier, trapping vast amounts of dust. This directly improves the air quality index (AQI) in one of the world\'s most polluted urban regions.',
        animationUpdate: 'Strong wind lines carrying dust are shown hitting the dense green wall and stopping, with clean air flowing over the other side towards a city skyline.',
      },
      {
        scenarioTitle: 'A Healthier Future',
        scenarioDescription: 'Decades later, the green wall is a thriving, self-sustaining ecosystem, a testament to ecological restoration.',
        question: 'What is the ultimate success of the Aravalli Green Wall?',
        correctAnswer: 'A restored ecological balance and a sustainable future for the region.',
        incorrectAnswers: [
          'It became the longest wall in the world.',
          'It completely stopped all rain.',
          'It made the desert disappear entirely.',
        ],
        explanation: 'The project\'s success lies in its holistic approach: halting desertification, conserving biodiversity, improving water security, and empowering local communities, creating a resilient and prosperous ecosystem for generations to come.',
        animationUpdate: 'The entire scene transforms into a lush green belt of trees, with birds flying, animals roaming, and communities thriving.',
      },
    ]
  },
];
